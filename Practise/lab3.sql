...
describe student
describe section
alter table student add constraint fk foreign key(dept_name) references department(dept_name) on delete cascade;

insert into section values(1,'A',1,2009,'A1',205,111)
insert into takes values(5,1,'A',1,2009,9)
insert into section values(2,'B',2,2015,'A2',300,222)
insert into takes values(2,2,'B',2,2015,10)
insert into section values(3,'A',3,2010,'A1',205,111)
insert into takes values(2,3,'A',3,2010,4);
...
(select course.title
from takes,course
where year=2009 and takes.course_id=course.course_id)
union
(select course.title
from takes,course
where year=2010 and takes.course_id=course.course_id)



select * from takes
insert into course values(5,'dsa','cse',4)
select * from course
